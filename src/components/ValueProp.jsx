export default function ValueProp() {
  const items = [
    {
      title: "Actu jeux vidéo",
      desc: "News claires, vérifiées, sans sensationnalisme."
    },
    {
      title: "Articles de joueurs",
      desc: "Des points de vue honnêtes, écrits par ceux qui jouent vraiment."
    },
    {
      title: "Guides & tips",
      desc: "Des guides utiles, pas des farm-tutos de 30 minutes."
    },
    {
      title: "Recommandations",
      desc: "Découvre des pépites adaptées à ton style de jeu."
    },
    {
      title: "Forums & débats",
      desc: "Un espace sain pour échanger entre passionnés."
    }
  ];
    ...
    <section className="relative w-full bg-[#0a0a0f] py-16 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((it) => (
            <div key={it.title} className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur transition-transform hover:scale-[1.01]">
              ...
              <h3 className="relative mb-2 text-lg font-semibold text-cyan-300">
                {it.title}
              </h3>
